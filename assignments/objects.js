...
// Log the child's age
console.log(parent.child.name + "'s age is " + parent.child.age)

// Log the name and age of the grandchild
console.log(parent.child.grandchild.name + "'s age is " + parent.child.grandchild.age)
